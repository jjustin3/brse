...
switch(BRSEAICount) do{
	case 0: {_PlayersDropCount = 5;};
	case 1: {_PlayersDropCount = 5;};
	case 2: {_PlayersDropCount = 5;};
	case 3: {_PlayersDropCount = 8;};
	case 4: {_PlayersDropCount = 3;};
	case 5: {_PlayersDropCount = 2;};
};
