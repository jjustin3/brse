...
switch(BRSEAICount) do{
	case 0: {_PlayersDropCount = 12;};
	case 1: {_PlayersDropCount = 12;};
	case 2: {_PlayersDropCount = 12;};
	case 3: {_PlayersDropCount = 10;};
	case 4: {_PlayersDropCount = 6;};
	case 5: {_PlayersDropCount = 6;};
};
